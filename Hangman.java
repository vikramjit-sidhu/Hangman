 ...
 */
    public void run() {
    	System.out.println("width of hangman: " + getHeight());
    	System.out.println("height of hangman: " + getHeight());
    	addCanvas();
    	System.out.println("width in text game: " + canvas.getWidth());
    	System.out.println("height in text game: " + canvas.getHeight());
    	playHangmanGame();
    }
    ...
    private void playHangmanGame() {
    	...
    	while (numGuessesLeft > 0) {
    		...
    		if (checkCharInString(wordToGuess, userInput)) {
    			...
    			/* Update the canvas with the incorrect guess */
 ...
 */
    private void updateRemainingWordToGuess(char userInput) {
    	remainingWordToGuess = remainingWordToGuess.replace(userInput, WORD_BLANK_CHAR);
    }
